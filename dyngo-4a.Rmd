...
- total number of ON-BCs can be found by counting rows with ON-BCs in the name with ON-BCs in the name
...
dyngo_plot <- uptake_plot(all_dyngo_exps, output_name = "all_dyngo_exps_ML_V2", condition_label = "Condition", add_stats = TRUE, dyngo_t_test)
dyngo_plot
```
