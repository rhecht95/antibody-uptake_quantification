...
**Note**: The machine learning model was trained on 6 channel images because a previous pipeline added two extra channels to every image as a byproduct of using an intensity threshold filter. These extra 2 channels contain no real information. 
...
temp_plot <- uptake_plot(all_temp_exps, output_name = "all_temp_exps_ML_V2", condition_label = "Incubation Temperature", add_stats = TRUE, temp_t_test)
temp_plot 
```
