...
`sum_intensities_3` represents the amount of 488-uptake signal present in a given Segment Uptake object. To calculate the total uptake for a given image, sum_intensities_3 must be summed for all of these objects. This will be divided by the total number of ON-BCs to produce `avg_upc`
