...
Seems that using the V5 pipeline, there is no differnce between the treatment conditions anymore... This is suspicious. When I glance at the number of ON-BCs in each image, it appears more variable than it should be. Let's take a look:
```{r}
all_temp_exps %>% 
  ggplot(aes(x = image_set, y = mean_inten))+
  geom_col()+
  facet_wrap(vars(condition), scales = "free_x")+
  theme_classic()+
  scale_y_continuous(expand = expansion(c(0,0.1)))+
  labs(x = "Image", y = "ON-BCs per image")+
