...
```{r}
temp_plot <- uptake_plot(all_temp_exps, output_name = "e450_e451_e452", condition_label = "Incubation Temperature", add_stats = TRUE, temp_t_test)
temp_plot 
  # stat_pvalue_manual(temp_t_test)+
  # labs(subtitle = get_test_label(temp_t_test))
```
