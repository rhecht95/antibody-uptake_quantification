...
```{r}
test_df <- as.data.frame(all_temp_exps[[1]])
...
test_df['sum_intensities'] <- sum_intensities #add the sum_intensities vector to the dataframe
test_df['on_bc_count'] <- num_on_bcs #add the number of ON-BCs in the image to the df
